      ...
      <div>
        ...
        {!best_sells ? (
          ...
          <div key={product.id_product}>
            ...
            <p>{product.storage}</p>
            <h4>{product.price}</h4>
            <h4><a href="/">Ajouter au panier</a></h4>
          </div>
        ))
      )}
        </div> 
        ...
        <h2><a href="/request">Créez votre PC</a></h2>
        </div>
        <div>
        <h2>Infos</h2>
        <h3>Decouvrez notre site de vente de PC pour gamers, où vous trouverez les meilleurs ordinateurs gaming pour améliorer votre expérience de jeu. Nous proposons une sélection de PC gaming haut de gamme, équipés des derniers composants. </h3>
